...
import { FolderKanban, CheckSquare, UserCircle } from "lucide-react"

const UserPanelNav = ({ isSidebarOpen }) => {

    const navItems = [
        { to: "/user/myprofile", icon: UserCircle, label: "My Profile" },
        { to: "/user/projects", icon: FolderKanban, label: "Projects" },
        { to: "/user/mytask", icon: CheckSquare, label: "My Tasks" },
    ]
